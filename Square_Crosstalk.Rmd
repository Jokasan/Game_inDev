---
title: "As total starts increases average cumulative play time increases"
...
y <- list(title="Average Cumulative Playtime (secs.)", range=c(0,15000))
...
div(
  h3("Filter by: checkpoint or averagge cumulative play time"),
  br(),
  bscols(
    widths = c(2, 10),
    list(
...
> A game in development has just been tested on 1000 users but only a few are getting to checkpoint 30. You have been provided with a summary of user data broken down by game checkpoint. Users can only progress to the next checkpoint when the previous has been passed. Users can re-play any passed checkpoint. This widget explores the relationship between total starts and average cummulative playtime. 
